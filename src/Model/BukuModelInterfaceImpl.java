...
public class BukuModelInterfaceImpl implements BukuModelInterface {
    ...
    public void updateJudul(String isbn, String judul) {
        try {
            String sql = "UPDATE BUKU SET buku_judul = false WHERE buku_isbn = ?";
            PreparedStatement stat = conn.prepareStatement(sql);
    ...
    @Override
    public void updatePenertbit(String isbn, String penerbit) {
        try {
            String sql = "UPDATE BUKU SET buku_penerbit = false WHERE buku_isbn = ?";
            PreparedStatement stat = conn.prepareStatement(sql);
